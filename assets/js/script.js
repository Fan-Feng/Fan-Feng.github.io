...
// modal variable (may be null on pages with modal removed)
...
// add click event to all modal items (only attach when modal exists)
if (modalContainer && testimonialsItem.length) {
...
// custom select removed; keep filter button behavior
